...
const getActivityIcon = (action, resourceType) => {
  if (action === 'uploaded' || action === 'published') return <CloudUploadIcon color="success" />;
          ...
          <StyledMetricCard color="primary">
            <CardContent sx={{ textAlign: 'center', p: 3 }}>
              ...
              <Typography variant="h3" component="div" fontWeight="bold">
                {isLoading ? <LinearProgress /> : <AnimatedCounter value={metrics.videosCount || 0} />}
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <StyledMetricCard color="secondary">
            <CardContent sx={{ textAlign: 'center', p: 3 }}>
              ...
              <Typography variant="h3" component="div" fontWeight="bold">
                {isLoading ? <LinearProgress /> : <AnimatedCounter value={metrics.blogsCount || 0} />}
              </Typography>
              <Typography variant="subtitle1" color="inherit" sx={{ opacity: 0.8 }}>
                Total Blogs
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <StyledMetricCard color="info">
            <CardContent sx={{ textAlign: 'center', p: 3 }}>
              ...
              <Typography variant="h3" component="div" fontWeight="bold">
                {isLoading ? <LinearProgress /> : <AnimatedCounter value={metrics.totalViews || 0} />}
              </Typography>
              <Typography variant="subtitle1" color="inherit" sx={{ opacity: 0.8 }}>
                Total Views
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <StyledMetricCard color="success">
            <CardContent sx={{ textAlign: 'center', p: 3 }}>
              ...
              <Typography variant="h3" component="div" fontWeight="bold">
                {isLoading ? <LinearProgress /> : <AnimatedCounter value={metrics.usersCount || 0} />}
              </Typography>
              <Typography variant="subtitle1" color="inherit" sx={{ opacity: 0.8 }}>
                Total Users
              </Typography>
                  ...
                  <TableBody>
                    {activities.map((activity, index) => (
                      <TableRow key={activity.resourceId || index} hover>
                            ...
                            <Box>
                              ...
                              <Box sx={{ display: 'flex', alignItems: 'center', mt: 0.5 }}>
                                ...
                                <Chip 
                                  ...
                                  size="small" 
                                  color={activity.resourceType === 'video' ? 'primary' : 'secondary'}
                                  variant="outlined"
                                  sx={{ ml: 1 }}
                                />
                              </Box>
                        ...
                        <TableCell align="right" sx={{ borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
              ...
              <Stack spacing={4}>
                <Box>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {(systemStatus.storage?.used / 1000000000 || 0).toFixed(0)} / {(systemStatus.storage?.capacity / 1000000000 || 0).toFixed(0)} GB
                    </Typography>
                  </Box>
                  <LinearProgress 
                    variant="determinate" 
                  ...
                  <Typography variant="caption" color="text.secondary" align="right" display="block" sx={{ mt: 0.5 }}>
                    {(systemStatus.storage?.usedPercentage || 0).toFixed(1)}% used
                  </Typography>
                </Box>
                ...
                <Box>
                  ...
                  <Grid container spacing={2} sx={{ mt: 1 }}>
                    ...
                    <Grid item xs={6}>
                      <Paper sx={{ p: 2, textAlign: 'center', bgcolor: 'secondary.light', color: 'secondary.contrastText', borderRadius: 2 }}>
                        <Typography variant="h4" fontWeight="bold">
